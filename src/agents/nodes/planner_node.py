...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "write the summary yourself. Preserve explicit presentation constraints: use numbered_list "
    "when the user asks to number the result, bullet_points for bullets, and pass point_count when "
    "the user requests an exact number of items. Apply the same rule when reformatting the summary "
    "from the previous turn. If the user asks to list/extract action items or tasks for their "
